...
@pytest.mark.asyncio
async def test_smtp_vacio_retorna_false_sin_excepcion():
    """Si smtp_host está vacío, retorna False sin lanzar excepción."""
...
async def test_smtp_configurado_envia_ok():
    """Con aiosmtplib mockeado y smtp configurado, retorna True."""
...
@pytest.mark.asyncio
async def test_smtp_error_retorna_false():
    """Si aiosmtplib lanza excepción, retorna False sin relanzar."""
    settings = _mock_settings(
