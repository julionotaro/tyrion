...
DOCUMENTOS_PRUEBA: dict[str, dict[str, Any]] = {
    ...
    # ── Caso real González Fernández (herencia, todo OK) ────────────────────────
    "doc-005": {
        "id": "doc-005",
        "tramite_id": "t-003",
        "nombre": "cti_gonzalez.pdf",
        "tipo_detectado": "cti",
        "validez": "VALIDO",
        "confianza": "ALTA",
        ...
        "tiene_archivo": False,
        "campos_extraidos": [
            {"campo": "matricula",        "valor": "5042 HZM",   "estado": "valido"},
            {"campo": "dni_adquirente",   "valor": "35306584C",  "estado": "valido"},
            {"campo": "dni_transmitente", "valor": "14958073T",  "estado": "valido"},
        ],
        "justificacion": "CTI de cambio de titularidad por herencia. Matrícula y DNIs presentes.",
    },
    "doc-005b": {
        "id": "doc-005b",
        "tramite_id": "t-003",
        "nombre": "decl_responsable_gonzalez.pdf",
        ...
        "tiene_archivo": False,
        "campos_extraidos": [
            {"campo": "nombre",    "valor": "María del Carmen Carballal Lores", "estado": "valido"},
            {"campo": "dni",       "valor": "35306584C",                         "estado": "valido"},
            {"campo": "matricula", "valor": "5042-HZM",                          "estado": "valido"},
        ],
        "justificacion": "Declaración responsable de fallecimiento. Nombre, DNI y matrícula presentes.",
    },
    "doc-005c": {
        "id": "doc-005c",
        "tramite_id": "t-003",
        "nombre": "modelo_650_gonzalez.pdf",
        ...
        "tiene_archivo": False,
        "campos_extraidos": [
            {"campo": "dni_causante",    "valor": "14958073T",   "estado": "valido"},
            {"campo": "dni_sujeto_pasivo", "valor": "35306584C", "estado": "valido"},
            {"campo": "importe",         "valor": "30.488,99 €", "estado": "valido"},
        ],
        "justificacion": "Modelo 650 (Impuesto Sucesiones). DNI causante y sujeto pasivo identificados.",
    },
    "doc-005d": {
        "id": "doc-005d",
        "tramite_id": "t-003",
        "nombre": "anexo_650_gonzalez.pdf",
        ...
        "tiene_archivo": False,
        "campos_extraidos": [
            {"campo": "matricula",      "valor": "5042HZM",            "estado": "valido"},
            {"campo": "bastidor",       "valor": "JYA5J09200002507G",  "estado": "valido"},
            {"campo": "valor_vehiculo", "valor": "539,50 €",           "estado": "valido"},
        ],
        "justificacion": "Anexo 650 con matrícula, bastidor y valor del vehículo. Todo consistente.",
    },
    "doc-005e": {
        "id": "doc-005e",
        "tramite_id": "t-003",
        "nombre": "cert_defuncion_gonzalez.pdf",
        "tipo_detectado": "certificado_defuncion",
        "validez": "VALIDO",
        "confianza": "ALTA",
        "confianza_score": 0.97,
        "tiene_archivo": False,
        "campos_extraidos": [
            {"campo": "nombre_fallecido",  "valor": "José Manuel González Fernández", "estado": "valido"},
            {"campo": "dni_fallecido",     "valor": "14958073T",                       "estado": "valido"},
            {"campo": "fecha_defuncion",   "valor": "01/09/2026",                      "estado": "valido"},
        ],
        "justificacion": "Certificado de defunción con nombre, DNI y fecha. Documento VÁLIDO.",
    },
    "doc-009": {
        "id": "doc-009",
        "tramite_id": "t-008",
        # Caso EVIDENCIA_COMPATIBLE: anexo_650 con bastidor que no coincide
        "nombre": "anexo_650_erroneo.pdf",
        "tipo_detectado": "anexo_650",
...
TRAMITES_PRUEBA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "gestoria": "Gestoria Carballal",
        "gestoria_email": "carballal@gestorias.es",
        "estado": "listo_dgt",
        "fecha_entrada": _hace(90),
        "alerta": False,
        "documentos": [
            {"id": "doc-005",  "nombre": "cti_gonzalez.pdf",
             "tipo_detectado": "cti",
             "validez": "VALIDO", "confianza": "ALTA"},
            {"id": "doc-005b", "nombre": "decl_responsable_gonzalez.pdf",
             "tipo_detectado": "declaracion_responsable_fallecimiento",
             "validez": "VALIDO", "confianza": "ALTA"},
            {"id": "doc-005c", "nombre": "modelo_650_gonzalez.pdf",
             "tipo_detectado": "modelo_650",
             "validez": "VALIDO", "confianza": "ALTA"},
            {"id": "doc-005d", "nombre": "anexo_650_gonzalez.pdf",
             "tipo_detectado": "anexo_650",
             "validez": "VALIDO", "confianza": "ALTA"},
            {"id": "doc-005e", "nombre": "cert_defuncion_gonzalez.pdf",
             "tipo_detectado": "certificado_defuncion",
             "validez": "VALIDO", "confianza": "ALTA"},
        ],
        "historial": [
            ...
            {"momento": _hace(89),
             "evento": "5 documentos clasificados (herencia González Fernández)",
             "actor": "tyrion"},
            {"momento": _hace(88),
             "evento": "Cotejo completado — matrícula, DNI causante y bastidor consistentes. Listo para DGT.",
             "actor": "tyrion"},
        ],
        "avisos_pendientes": [],
        "verificaciones": [
